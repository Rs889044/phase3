...
\begin{itemize}
    ...
    \item $K$: The carrying capacity --- the asymptotic plateau of the S-curve. Because SOH is normalized by \emph{rated} capacity, fitted values of $K$ may exceed $1.0$ for cells whose measured initial capacity is above rating (as observed for the NASA cells in Chapter~\ref{ch:results}).
\end{itemize}
